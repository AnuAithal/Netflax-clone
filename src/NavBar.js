...
function NavBar() {
  ...
  return (
    <nav className="navbar">
      ...
      />
      <div style={{ display: "flex", marginLeft: "30px", fontSize: "17px" }}>
        <a class={`nav-item nav-link ${location.pathname === "/home" ? "active" : ""}`} href="/home">
          Home
        </a>
        <a
          style={{ marginLeft: "20px" }}
          class={`nav-item nav-link ${location.pathname === "/movies" ? "active" : ""}`}
          href="/movies"
        >
          Movies
        </a>
